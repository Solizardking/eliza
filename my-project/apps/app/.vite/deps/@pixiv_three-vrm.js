...
function setTextureColorSpace(texture, colorSpace) {
	if (parseInt("184", 10) >= 152) texture.colorSpace = colorSpace;
...
function getTextureColorSpace(texture) {
	if (parseInt("184", 10) >= 152) return texture.colorSpace;
...
var MToonMaterial = class extends ShaderMaterial {
	...
	*/
	_generateDefines() {
		const threeRevision = parseInt("184", 10);
